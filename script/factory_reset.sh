...
#exp_internal 1
# 디버깅시 주석 제거
#log_file factory_reset_debug.log
# 모든 명령어 전 대기 시간
set timeout 5

#로그파일 초기화
file delete "factory_reset.log"
...
# Serial과 MAC 주소 추출 및 공장 초기화/재부팅을 처리하는 프로시저
proc process_device {ip user pass new_ip subnet gw sz hostname} {
    ...
    puts "(AP $ip를 공장초기화완료하여 재부팅합니다. 다음 장비로 이동합니다.)"
}
...
set result_fp [open "factory_reset_result.csv" w]
